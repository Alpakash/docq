						...
						<div className="flex justify-between h-16">
							<div className="flex px-2 lg:px-0">
								...
								<div className="hidden lg:ml-6 lg:flex lg:space-x-8">
									<NavLink
										to="/"
										className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 text-sm border-b-2 font-medium"
										activeClassName="text-gray-900 border-indigo-500 border-b-2 hover:border-indigo-500 hover:text-gray-900"
										exact
									>
										Home
									</NavLink>
